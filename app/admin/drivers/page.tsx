...
function availabilityTone(a: Driver["availability"]): "green" | "red" | "gray" {
  if (a === "online") return "green";
  if (a === "offline") return "red";
  return "gray";
}
      ...
      <div className="mx-auto w-full max-w-6xl p-6 space-y-6">
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-zinc-800">Drivers</p>
          </div>
              ...
              <tbody className="text-sm">
                {filtered.map((d, idx) => (
                  ...
                  >
                    ...
                    <td className="py-3 px-4">
                      <Badge tone={availabilityTone(d.availability)}>
                        {d.availability}
                      </Badge>
                    </td>

                    <td className="py-3 px-4 text-zinc-800">{fmtDate(d.last_seen_at)}</td>
                  </tr>
                ))}

                {filtered.length === 0 && (
                  <tr>
                    <td colSpan={5} className="py-10 px-4 text-center text-zinc-600">
                      <div className="mx-auto max-w-md space-y-2">
                        ...
                        <div className="text-sm">
                          {drivers.length === 0
                            ? "Drivers will appear once they’ve created a profile in the driver app."
